...
const initializeDefaultSystemSettings = async () => {
    try {
        ...
        if (count === 0) {
            ...
            await SystemSettings.updateOne({ settingKey: 'reviewPoints' }, { $setOnInsert: { settingKey: 'reviewPoints', settingValue: 50, description: 'Points awarded for submitting a product review' } }, { upsert: true });
        }
    }
    catch (e) {

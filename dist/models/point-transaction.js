...
const PointTransactionSchema = new mongoose_1.Schema({
    ...
    reason: {
        type: String,
        enum: ['check-in', 'referral', 'feedback', 'prediction-win', 'admin-grant', 'streak-bonus', 'survey-completion', 'order-completion', 'vote', 'vote-removal', 'contest-participation', 'contest-win', 'review-reward'],
        required: true,
        index: true,
    },
    notes: { type: String },

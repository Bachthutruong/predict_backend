...
const SystemOrderItemSchema = new Schema({
...
const SystemOrderSchema = new Schema({
  ...
  user: { type: Schema.Types.ObjectId, ref: 'User', required: false }, // Optional for guest orders
...
const SystemOrder = models?.SystemOrder || model('SystemOrder', SystemOrderSchema);
